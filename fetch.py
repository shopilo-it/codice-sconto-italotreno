#!/usr/bin/env python3
"""
Recupero codici sconto Italo Treno da shopilo.it
Sursa: https://shopilo.it/negozi/italotreno.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/italotreno.it"
STORE_NAME = "Italo Treno"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Italo Treno da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-italotreno)"
    }
    try:
